...
// get the object storedin the local storage
...
// set the stored object in local storeage
...
function init() {
	...
	if ( Object.keys( ptt ).length > 1 ) {
		...
		// Move authorization process to   tab!
	...
	// 	success: function(r) {
	// 		console.log( r );
	// 		$('.ptt-app').load('/view/test.html', ptt );
	// 	},
	// 	error: function(e) {
	// 		console.log( e );
	// 	}
